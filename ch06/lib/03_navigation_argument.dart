/*
  날짜 : 2025/10/28
  이름 : 이수연
  내용 : Flutter 6장 Navigation Routes 기본 실습
*/
...
class _FirstScreenState extends State<FirstScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('03.Flutter 네비게이션 실습')),
      body: Column(
        children: [
          TextField(
          ...
          ElevatedButton(
            onPressed: (){
              ...
              int age = int.tryParse(_ageController.text) ?? 0; // null이면 0을 대입한다.
              ...
              //Navigator.pushNamed(context, '/secone');
            },
