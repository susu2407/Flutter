...
class _HomeTabState extends State<HomeTab> {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            _buildProductSection(context, 'BEST 상품'),
  ...
  // 상품 섹션 디자인 함수
  Widget _buildProductSection(BuildContext context, title) {
    return Column(
  ...
  Widget _buildFooter(BuildContext context){
    return Container(
      ...
      child: Column(
        children: [
          Text('회사 정보 및 약관'),
          Text('고객센터 : 000-000-000', style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
          Text('ⓒKmarket Shopping App. All right reserved', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
        ],
      ),
    );
  }
