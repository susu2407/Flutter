/*
  날짜 : 2025/10/28
  이름 : 이수연
  내용 : Flutter 5장 04.Riverpod 상태 관리 실습
...
class ParentWidget extends ConsumerWidget {
  ...
  @override
  Widget build(BuildContext context, WidgetRef ref) { // ref : Riverpod 상태 모델 접급을 위해 ...
      ...
      children: [
        ...
        CheckboxListTile(
          title: const Text('동의합니다.'),
            value: check,
            onChanged: (value){
            ref.read(checkProvider.notifier).state = value ?? false; // nullable인 value에서, null이면 false가 되도록
            }
        ),
      ],
    );
